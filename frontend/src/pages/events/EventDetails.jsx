...
// Testing the option of chat and the announcement
    ...
    <>
      ...
      <div className="flex gap-2 mb-3">
        <button
          ...
          className="px-3 py-1 rounded-xl text-xs font-bold bg-blue-600 text-white"
        >
          Chat
        </button>
        ...
        <button
          ...
          className="px-3 py-1 rounded-xl text-xs font-bold bg-slate-200 text-slate-700"
        >
          Announcements
        </button>
         {isAuthorizedManager && (
      ...
      <div className="min-h-screen bg-slate-100 p-4 md:p-6 space-y-4 font-sans text-slate-800 antialiased">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div
              ref={announcementRef}
              className="bg-white shadow-xl rounded-2xl p-6 border border-slate-100"
            >
              <h3 className="text-sm font-bold text-slate-800 mb-4 flex items-center gap-2">
                <span>🔔</span> Announcement History Logs
              </h3>
          ...
          <div
            ref={chatRef}
            className="lg:col-span-1 flex flex-col h-[550px] lg:h-auto min-h-[500px] bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden"
          >
            {/* TOP HEADER STATUS RIBBON */}
            <div className="bg-slate-900 px-5 py-4 text-white flex items-center gap-2 shrink-0 select-none">
              <FiMessageSquare className="text-xl text-blue-400" />
